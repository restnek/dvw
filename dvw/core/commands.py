...
from .util.click import IgnoreRequiredWithHelp, update_context, EnumType, default_help_context
...
@click.command(
    help='DWT window median',
    short_help='DWT window median')
@click.option(
    '--wavelet',
    type=Choice(wavelist()),
    default='haar',
    help='Wavelet to use')
@click.option(
    '--level',
